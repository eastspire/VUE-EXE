...
// 文档图标
const docs_icon = nativeImage.createFromPath(path.join(__dirname, '../src/photo/docs.png')).resize({ width: 22, height: 22 });

// 最小化图标
const minimize_icon = nativeImage.createFromPath(path.join(__dirname, '../src/photo/minimize.png')).resize({ width: 22, height: 22 });

// 最大化图标
const maximize_icon = nativeImage.createFromPath(path.join(__dirname, '../src/photo/maximize.png')).resize({ width: 22, height: 22 });

// 在线图标
const online_icon = nativeImage.createFromPath(path.join(__dirname, '../src/photo/online.png')).resize({ width: 22, height: 22 });

// 在线代码编辑器图标
const web_ide_icon = nativeImage.createFromPath(path.join(__dirname, '../src/photo/web-ide.png')).resize({ width: 22, height: 22 });

// 重启图标
const restart_icon = nativeImage.createFromPath(path.join(__dirname, '../src/photo/restart.png')).resize({ width: 22, height: 22 });
...
const language_map = {
    'C': {
        value: 'c',
        icon: nativeImage.createFromPath(path.join(__dirname, '../src/photo/c.png')).resize({ width: 22, height: 22 })
    },
    'C++': {
        value: 'cpp',
        icon: nativeImage.createFromPath(path.join(__dirname, '../src/photo/cpp.png')).resize({ width: 22, height: 22 })
    },
    'Rust': {
        value: 'rust',
        icon: nativeImage.createFromPath(path.join(__dirname, '../src/photo/rust.png')).resize({ width: 22, height: 22 })
    },
    'JavaScript': {
        value: 'javascript',
        icon: nativeImage.createFromPath(path.join(__dirname, '../src/photo/javascript.png')).resize({ width: 22, height: 22 })
    },
    'TypeScript': {
        value: 'typescript',
        icon: nativeImage.createFromPath(path.join(__dirname, '../src/photo/typescript.png')).resize({ width: 22, height: 22 })
    },
    'PHP': {
        value: 'php',
        icon: nativeImage.createFromPath(path.join(__dirname, '../src/photo/php.png')).resize({ width: 22, height: 22 })
    },
    'JAVA': {
        value: 'java',
        icon: nativeImage.createFromPath(path.join(__dirname, '../src/photo/java.png')).resize({ width: 22, height: 22 })
    },
    'GoLang': {
        value: 'golang',
        icon: nativeImage.createFromPath(path.join(__dirname, '../src/photo/golang.png')).resize({ width: 22, height: 22 })
    },
    'Python3': {
        value: 'python3',
        icon: nativeImage.createFromPath(path.join(__dirname, '../src/photo/python3.png')).resize({ width: 22, height: 22 })
    },
    'C#': {
        value: 'csharp',
        icon: nativeImage.createFromPath(path.join(__dirname, '../src/photo/csharp.png')).resize({ width: 22, height: 22 })
    },
    'Ruby': {
        value: 'ruby',
        icon: nativeImage.createFromPath(path.join(__dirname, '../src/photo/ruby.png')).resize({ width: 22, height: 22 })
    },
};
